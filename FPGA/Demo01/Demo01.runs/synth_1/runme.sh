...
HD_PWD='C:/Users/natha/OneDrive/Code/DopplerDynamics/IVUS-Doppler/FPGA/Demo01/Demo01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_blink.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_blink.tcl
